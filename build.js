...
$__System.register('1', [], function (_export) {
  // model
  'use strict';

  var collection, addTodo, addTodoForm, todos;
  ...
  return {
    setters: [],
    execute: function () {
      collection = localStorage.getItem('todos') ? JSON.parse(localStorage.getItem('todos')) : [];
